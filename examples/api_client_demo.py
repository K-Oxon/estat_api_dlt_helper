...
def demo_api_client():
    ...
    if not api_key:
        print("Warning: ESTAT_API_KEY not set. This demo will show usage but not make actual API calls.")
            ...
            if "STATISTICAL_DATA" in stats_data:
                ...
                if "TABLE_INF" in statistical_data:
                    ...
                    if "VALUE" in table_inf and table_inf["VALUE"]:
                        ...
                        print("First record keys:", list(table_inf["VALUE"][0].keys()) if table_inf["VALUE"] else "No data")
