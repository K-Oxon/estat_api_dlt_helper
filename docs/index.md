...
- `estat_table` / `estat_source`
  ...
  - `create_estat_resource` / `create_estat_pipeline` / `create_estat_source` と並ぶ、dltを利用した高度な使い方です。
...
see: [examples (estat_table / estat_source)](./examples/declarative_api_example.md)
